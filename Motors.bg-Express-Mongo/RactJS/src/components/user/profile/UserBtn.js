...
const UserBtn = (props) => {
    ...
    return (<Fragment>
        <input onClick={handleDelete} type="submit" value="Delete" id="btnDelMoto" />
        <Link className="btn btn-primary" to={editUrl} role="button">Edit</Link>
        <Link to={url}><button className="btn btn-secondary">Details</button></Link>
    </Fragment>)
}
